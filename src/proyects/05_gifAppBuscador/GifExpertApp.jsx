...
const GifApp = () => {
    ...
    return (
        <>
            <div className="app-container-0">
                <div className="containerGifRow">
                    <div className="containerGifColumn">
                        <p className="app-text">Buscador Gif App!</p>

                        {/*
            Agregar una nueva categoría
            - Comunicación entre Componentes: AddCategory.jsx
